// A Universal Windows Platform Core Application template, writen in C++/WRT and recreated from Microsoft Windows Samples by Nenad Rakas
#include "pch.h"
...
GameRenderer::GameRenderer(std::shared_ptr<DX::DeviceResources> const& deviceResources) :
    ...
    m_gameHud(deviceResources, L"Universal Windows Platform", L"WRT simulation template")
{
...
IAsyncAction GameRenderer::CreateGameDeviceResourcesAsync(_In_ std::shared_ptr<FPSim> game)
{
    ...
    winrt::com_ptr<ID3D11Device3> d3dDevice = m_deviceResources->GetD3DDevice();
    ...
    BasicLoader loader{ d3dDevice, nullptr };
