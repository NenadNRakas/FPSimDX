...
BasicLoader::BasicLoader(winrt::com_ptr<ID3D11Device3> d3dDevice, IWICImagingFactory2* wicFactory)
...
)
{
    ...
    SetDebugName(*vertexBuffer, debugName); //debugName + L"_VertexBuffer"
    SetDebugName(*indexBuffer, debugName); //debugName + L"_IndexBuffer"
